#C:/Users/louis/AppData/Local/Programs/Python/Python39/python.exe "c:/Users/louis/OneDrive/Bureau/PA-LAT/PA_LAT_FINAL.py" 
...
def Capture_AXE():
    ...
    if khi_c*(180/math.pi) <0 :
        ...
        khi_c= khi_c - 360*(math.pi/180)
    print('Envoie cap (fct axe) :', khi_c*(180/math.pi))
    Capture_ROUTE(khi_c)
...
def Capture_CAP (target):
    ...
    print("rollangle limite ", Max_Roll*(180/math.pi), "en deg")
...
# FM_Active_leg x1=0 x2=15000 y1=0 y2=15000 h_contrainte=0
