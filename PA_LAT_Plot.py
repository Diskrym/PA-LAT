...
# Variables pour enregistrer les valeurs et les temps
phi_values = []
psi_values = []
timestamps = []
...
def plot_graphs():
    # Tracé de la courbe pour phi
    plt.figure(1)
    plt.plot(timestamps, phi_values)
    plt.xlabel('Temps')
    plt.ylabel('Phi')
    plt.title('Variation de Phi')

    # Tracé de la courbe pour psi
    plt.figure(2)
    plt.plot(timestamps, psi_values)
    plt.xlabel('Temps')
    plt.ylabel('Psi')
    plt.title('Variation de Psi')
