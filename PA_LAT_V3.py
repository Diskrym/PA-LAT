...
def Capture_ROUTE(khi_c): 
    ...
    if Fcu_Mode == "Managed" :
        ...
        print('cos de fpa',math.cos(fpa))
        print('V_wind',V_Wind)
        print('comp',Wind_Comp * (180/math.pi))
        print('di')
        print('khi_c')
        print('direction vent', direction_vent_vrai * (180/math.pi))
        print('khi_c-dir vent',khi_c-direction_vent_vrai)
        print('sin de khi_c-dir vent',math.sin(khi_c-direction_vent_vrai))
        print('vp',Vp)
        print('d',d)
